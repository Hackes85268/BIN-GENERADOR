...
def usage():
    ...
    print("\033[1;31m")
    print("+---------------+")
    print("+\033[;32m Editado por HACKED\033[1;31m +")
    print("+---------------+\033[0m")
    print("")
    print("\033[1;33m Nickname: HACKED AD\033[0m")
    print("\033[1;33m Youtube: HACKED AD\033[0m")
    print("\033[1;33m Telegram: https://t.me/hackedAD \033[0m")
    print("\033[1;33m Facebook: Hacked ad")
    print("")
